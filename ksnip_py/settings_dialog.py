...
class SettingsDialog(QDialog):
    def __init__(self, initial: SettingsData, watermark_store: WatermarkStore, parent: QWidget | None = None) -> None:
        ...
        self.tool_combo.addItem("Marker Rectangle", Tool.MARKER_RECT)
        self.tool_combo.addItem("Marker Ellipse", Tool.MARKER_ELLIPSE)
        self.tool_combo.addItem("Text", Tool.TEXT)
        self.tool_combo.addItem("Text Pointer", Tool.TEXT_POINTER)
        self.tool_combo.addItem("Text Arrow", Tool.TEXT_ARROW)
        self.tool_combo.addItem("Number", Tool.NUMBER)
        self.tool_combo.addItem("Number Pointer", Tool.NUMBER_POINTER)
